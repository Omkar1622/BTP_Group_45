...
def send_image(url):
    ...
    try:
        os.system("python eval.py --trained_model=./weights/yolact_plus_resnet50_car_damage_128_2692_interrupt.pth --config=yolact_resnet50_car_damage_config --score_threshold=0.3 --top_k=15 --images=car_damage/car_damage/real_test:output_images")
    except Exception as e:
